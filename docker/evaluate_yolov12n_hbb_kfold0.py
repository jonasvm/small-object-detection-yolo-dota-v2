...
# ===== Caminhos (Linux) =====
model_path = '/home/jonasvm/docker-images/meus_resultados/detect/train51/weights/best.pt'
results_csv = '/home/jonasvm/docker-images/meus_resultados/detect/train51/results.csv'
...
print("\n### 🧪 Resultados — YOLOv12n (100 épocas, imgsz 1024, Adam, HBB)")
print(
