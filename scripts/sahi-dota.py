...
# ========= CONFIGURE AQUI =========
IMAGES_DIR     = "/home/jonasvm/docker-images/teste-sahi"      # ex: "/home/user/dota/images"
LABELS_DIR     = "/home/jonasvm/docker-images/teste-sahi"       # ex: "/home/user/dota/labels"
OUT_IMAGES_DIR = "/home/jonasvm/docker-images/teste-sah/sliced"           # ex: "/home/user/dota_sliced/images"
OUT_LABELS_DIR = "/home/jonasvm/docker-images/teste-sahi/sliced"           # ex: "/home/user/dota_sliced/labels"
...
# Critério robusto de inclusão: centróide do OBB deve cair dentro do tile
EDGE_TOL_PX  = 1.0  # tolerância de borda (px)
PREVIEW_MAX  = 12   # quantos tiles mostrar no final (grid)
# ===================================
...
def _centroid4(pts_abs):
    # centróide simples de 4 vértices (px, imagem original)
...
def read_yolo_obb_label(path_txt):
    ...
    com coords normalizadas [0,1].
    Retorna: [(cls_id, [(x1,y1),(x2,y2),(x3,y3),(x4,y4)]), ...]
    """
    anns = []
...
def _get_tile_origin_from_sahi(s):
    """
    Extrai (x0, y0, w, h) do dict do SAHI, quando presente.
    """
...
for img_name in image_files:
    ...
    # Imagem + labels da imagem inteira
    ...
    for idx, s in enumerate(slices):
        ...
        # ----- Label do tile (YOLO-OBB via centróide) -----
